package ee.kaspar.proovikontrolltoo;
...
public class ToiduaineController {
    ...
    //localhost:8080/leia-rasva-alusel?alg=1&lopp=5
    ...
    //localhost:8080/leia-rasva-alusel2?alg=1&lopp=5
    ...
    public List<Toiduaine> leiaRasvaAlusel2(
        ...
        for (int i = 0; i < toiduained.size(); i++) {
            if (toiduained.get(i).getRasv() > alg && toiduained.get(i).getRasv() < lopp) {
